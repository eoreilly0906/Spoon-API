  ...
  return (
    <div className="container mx-auto px-4 py-8 mt-16 min-h-screen bg-dark-background">
      <div className="max-w-3xl mx-auto">
        ...
        {error && (
          <div className="p-4 mb-8 bg-red-900/50 border-l-4 border-red-600 text-dark-text rounded">
            {error}
          </div>
        )}
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <Select
                  ...
                  onValueChange={(value) => setFormData(prev => ({ ...prev, mealType: value as MealTypes }))}
                >
